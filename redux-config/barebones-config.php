<?php
     ...
     */
     ...
     Redux::setSection( $opt_name, array(
         'title'  => __( 'Basic', 'redux-framework-demo' ),
         'id'     => 'basic',
     ...
     Redux::setSection( $opt_name, array(
         ...
         'desc'       => __( '', 'redux-framework-demo' ),
         'id'         => 'social-media-subsection',
         'subsection' => true,
         'fields'     => array(
             array(
                 'id'       => 'link-facebook',
                 'type'     => 'text',
                 'title'    => __( 'Facebook link profile', 'redux-framework-demo' ),
                 'subtitle' => __( '', 'redux-framework-demo' ),
                 'desc'     => __( '', 'redux-framework-demo' ),
                 'default'  => '',
             ),
             array(
                 'id'       => 'link-twitter',
                 'type'     => 'text',
                 'title'    => __( 'Twitter link profile', 'redux-framework-demo' ),
                 'subtitle' => __( '', 'redux-framework-demo' ),
                 'desc'     => __( '', 'redux-framework-demo' ),
                 'default'  => '',
             ),
